"""Google tools for AGClaw — Gmail, Calendar, Drive.
...
agent only gets these tools when the user is signed in (`agclaw google login`).
"""
...
from agclaw.integrations.google_auth import build_service
