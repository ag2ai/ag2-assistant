...
See `LOCAL_PATHS.md` for local clone locations (not committed).

- **AG2:** https://github.com/ag2ai/ag2 — Beta module at `autogen/beta/`
- **OpenClaw:** https://github.com/openclaw/openclaw — TypeScript reference implementation
